...
<style>
    body, .jp-Notebook, .container, .output_wrapper, .output_area {
        ...
        overflow-x: hidden; /* prevent horizontal scrollbars when wide elements are present */
    }
    ...
    .civit-token-input input,
    .civit-token-input .widget-text {
